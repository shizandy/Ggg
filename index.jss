          ...
          try {
            ...
            if (auth.config.status === 'new') {
              ...
              if (registerResult.success) {
                ...
                // Si l'instance était déjà approuvée, continuer l'exécution sans redémarrer
                if (registerResult.alreadyApproved) {
                  console.log('Instance déjà approuvée, poursuite de l\'exécution');
                  // On continue l'exécution du bot sans redémarrer
                } else {
            ...
            if (!validationResult.success) {
              ...
              if (validationResult.fallbackMode) {
                console.log('Mode repli activé: utilisation d\'une autorisation locale précédente');
              } else {
            ...
            setInterval(async () => {
              try {
                ...
                if (!checkResult.success && !checkResult.fallbackMode) {
